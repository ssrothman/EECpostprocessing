if __name__ == '__main__':
    ...
    if args.local:
        ...
        sample = SAMPLE_LIST.lookup(tmp)
        print("Sample list")
        print(SAMPLE_LIST.get_samples())
        #print(sample)
        #print(args.sample)
    ...
    if args.local:
        ...
        destination = "/afs/cern.ch/user/d/dponman/EECpostproc/tmp/%s/%s/%s"%(SAMPLE_LIST.tag, sample.name, args.binningtype)
