...
error                     = condor/NAME_$(CLUSTER)_$(Process).err
log                       = condor/NAME_$(CLUSTER)_$(Process).log
max_retries               = 4
