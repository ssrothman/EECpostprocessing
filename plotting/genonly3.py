...
for table in ['GenSplittingsHardSide', 'GenSplittingsSoftSide', 'DeltaPsiHardSide', 'DeltaPsiSoftSide']:
    ...
    flavcut = splt.cut.AndCuts([
        splt.cut.EqualsCut(splt.variable.BasicVariable('pdgId1'), 21),
        splt.cut.EqualsCut(splt.variable.BasicVariable('pdgId2'), 21),
        splt.cut.EqualsCut(splt.variable.BasicVariable('pdgId3'), 21),
        splt.cut.EqualsCut(splt.variable.BasicVariable('pdgId4'), 21),
        splt.cut.EqualsCut(splt.variable.BasicVariable('pdgId5'), 21),
        splt.cut.EqualsCut(splt.variable.BasicVariable('pdgId6'), 21)
    ])
