...
class EECres4minRBinner(EECgenericBinner):
    def __init__(self, config,
                 manualcov, poissonbootstrap, statsplit,
                 sepPt):
        super(EECres4minRBinner, self).__init__(config,
    ...
    def binAll(self, readers, mask, evtMask, wt):
        ...
        if self.isMC:
            ...
            result['recopure'] = self.binObserved(
                    ...
                    mask, wt, 
                    noCov=True,
                    subtract = readers.rRecoEECUNMATCH.res4minR)
            result['gen'] = self.binObserved(
                    readers.rGenEEC.res4minR,
                    readers.rGenJet,
            ...
            result['genpure'] = self.binObserved(
                    ...
                    mask, wt, 
                    noCov=True,
                    subtract = readers.rGenEECUNMATCH.res4minR)
